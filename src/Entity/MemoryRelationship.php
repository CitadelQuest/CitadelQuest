...
/**
 * Memory Relationship entity for CQ Memory Pack (.cqmpack)
 * 
 * Represents edges in the memory graph between MemoryNodes.
 */
class MemoryRelationship implements JsonSerializable
{
    private string $id;
