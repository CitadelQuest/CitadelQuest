...
Encore
    ...
    .addEntry('app-public', './assets/entries/app-public.js')
    ...
    .addEntry('admin-system-backups', './assets/entries/admin-system-backups.js')
    ...
    .addEntry('cq-imager', './assets/entries/cq-imager.js')
    ...
    .addEntry('settings-ai-tools', './assets/entries/settings-ai-tools.js')
