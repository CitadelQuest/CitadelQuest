...
1. **CitadelQuest Logo** — click to return to Dashboard
2. **Spirit Icon** — click to open Spirits list Dropdown
...
3. **User Menu** (your username):
   ...
   - Admin (if admin)
   - Logout
4. **CQ Chat** — dropdown with recent conversations and unseen message count
5. **Notifications** — bell icon with unread notification count
6. **Language** — switch between English, Czech, and Slovak
