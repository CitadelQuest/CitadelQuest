...
2. Select or drag&drop files from your device
3. Files are uploaded to your current directory

### Creating Folders
1. Click the **New Folder** button
2. Enter a name
3. The folder is created in your current directory

### Creating Files
1. Click the **New File** button
2. Enter a filename
3. An empty file is created — you can edit it or let your Spirit fill it with content
